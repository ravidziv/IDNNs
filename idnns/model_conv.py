...
class Model:
    ...
    def __init__(self,input_size, layerSize, num_of_classes,learning_rate_local, save_file, model_type=0):
        self.input_size = input_size
        self.layerSize = layerSize
        self.all_layer_sizes = layerSize
        self.all_layer_sizes.insert(0, input_size)
    ...
    def hidden_layers(self):
        if self.hidden is None:
            ...
            y_conv, keep_prob = deepnn(self.x)
    ...
    def cross_entropy(self):
        ...
        cross_entropy = tf.reduce_mean(-tf.reduce_sum(self.labels * tf.log(tf.clip_by_value(self.prediction,1e-10, 1.0 )), reduction_indices=[1]))
